#!/usr/bin/env bash
# =============================================================================
# submit_interpret_acr_best.sh  —  Interpretability for ACR classification
# =============================================================================
# Runs interpret_mm_abmil.py (--task acr) for the best variant
# (iterative_r2_k16_cls), split 0, folds 0-3.
...
RESULTS_DIR="${CHICAGO_MIL}/results_mm_abmil_v6_milv2"
...
OUT_BASE="${CHICAGO_MIL}/results/acr/interpretability"
...
echo "========================================================================"
echo "  submit_interpret_acr_best.sh  —  ACR classification interpretability"
...
for fold in "${FOLD_ARRAY[@]}"; do
    ...
    JOB_NAME="interp_acr_s${SPLIT}f${fold}"
...
echo "==== Interp ACR [${VARIANT}] split=${SPLIT} fold=${fold} | \$(date) ===="
