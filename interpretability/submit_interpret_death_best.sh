#!/usr/bin/env bash
# =============================================================================
# submit_interpret_death_best.sh  —  Interpretability for death survival
# =============================================================================
# Runs interpret_mm_abmil.py (--task survival --surv_endpoint death) for the
# best variant (early_cls), split 1, folds 0-3.
...
RESULTS_DIR="${CHICAGO_MIL}/results/death_survival/runs"
...
OUT_BASE="${CHICAGO_MIL}/results/death_survival/interpretability"
...
echo "========================================================================"
echo "  submit_interpret_death_best.sh  —  death survival interpretability"
...
for fold in "${FOLD_ARRAY[@]}"; do
    ...
    JOB_NAME="interp_death_s${SPLIT}f${fold}"
...
echo "==== Interp death [${VARIANT}] split=${SPLIT} fold=${fold} | \$(date) ===="
