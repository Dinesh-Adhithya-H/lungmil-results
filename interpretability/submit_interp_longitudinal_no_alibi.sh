#!/bin/bash
#SBATCH --job-name=interp_long_noalibi
#SBATCH --output=/ictstr01/home/aih/dinesh.haridoss/chicago_mil/results/mm_abmil_v8/slurm_logs/%j_interp_longitudinal_no_alibi.out
#SBATCH --error=/ictstr01/home/aih/dinesh.haridoss/chicago_mil/results/mm_abmil_v8/slurm_logs/%j_interp_longitudinal_no_alibi.err
...
echo "===  Longitudinal No-ALiBi Interpretability  ==="
echo "    variant=${VARIANT}  split=${SPLIT}  fold=${FOLD}  task=${TASK}  n_patients=${N_PATIENTS}"
